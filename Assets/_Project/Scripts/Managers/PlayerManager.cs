...
namespace SpectrobesTCG
{
    public class PlayerManager
    {
        ...
        public PlayerManager(GameManager.PlayerIds playerId, Dictionary<string, Transform> cardListTransforms)
        {
            ...
            deckZone = new CardZone(id, CardZone.GroupingType.stack, cardListTransforms["deck"], 10);
            handZone = new CardZone(id, CardZone.GroupingType.hand, cardListTransforms["hand"], 100);
            discardZone = new CardZone(id, CardZone.GroupingType.stack, cardListTransforms["discard"], 10);
            ...
            */
            boardZone = new CardZone(id, CardZone.GroupingType.board, cardListTransforms["deck"], 0);
